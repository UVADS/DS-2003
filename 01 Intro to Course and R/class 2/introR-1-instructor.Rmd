...
```{r}
# (s7) Write an equation that equal 25 where PEMDAS is applicable
...
```{r}
# (s7b) Write an expression with a logical operator that will return FALSE
(2^2) != 4
```
...
tv <- c("Ted Lasso", "Only Murders in the Building", "Stranger Things")
```
...
days_name <- c("Sunday", "Monday", "Tuesday", "Thursday", "Friday", "Saturday", "Sunday")
